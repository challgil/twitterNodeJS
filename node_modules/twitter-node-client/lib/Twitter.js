...
Twitter.prototype.getTweet = function (params, error, success, response, obj, i) {
    var path = '/statuses/show.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success, response, obj, i);
};
...
Twitter.prototype.getCustomApiCall = function (url, params, error, success, res, obj) {
    var path =  url + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success, res, obj);
};
...
Twitter.prototype.doRequest = function (url, error, success, other, obj) {
    ...
    this.oauth.get(url, this.accessToken, this.accessTokenSecret, function (err, body, response) {
        ...
        console.log("Making a twitter API call!");
        if (!err && response.statusCode == 200) {
            success(body, other, obj);
        } else {
